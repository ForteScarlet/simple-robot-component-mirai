...
注①：需要使用协议`simbot.mirai.protocol=ANDROID_PHONE`
注②：bot自己发出的戳事件不会被触发。（`bot.id == event.from.id`）

# 1.8.4-1.16
- 更新cqcodeutils到`v1.8.1`
...
- `cqcodeutils` 更新到`v1.8.0-BETA.3`
- 修复好友添加申请和入群申请的msg无法获取的问题
